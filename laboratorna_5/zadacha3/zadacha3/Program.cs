...
{
    public Skirt(int sizeClothes, double price, string color) : base(sizeClothes,
   price, color)
    { }
    public void dressWoman()
    {
...
{
    public Necktie(int sizeClothes, double price, string color) : base(sizeClothes,
   price, color)
    { }
    public void dressMan()
    {
...
class Atelier
{
    public void dressMan()
    {
        ...
        IMenswear[] menswears = { new TShirt(38, 325.50, "бiлий"), new Pants(43,
725.99, "чорний"), new Necktie(8, 90.45, "чорний") };
    ...
    public void dressWoman()
    {
        ...
        IWomenswear[] womenswears = { new TShirt(35, 336.10, "оранжеий"), new
Pants(38, 825.15, "бiлий"), new Skirt(6, 85.99, "бiлий") };
